  ...
  return (
    <main style={{minHeight: '100vh', background: '#f5f4f0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Helvetica Neue', Arial, sans-serif"}}>
      <div style={{background: 'white', border: '1px solid #e2e0d8', borderRadius: '12px', padding: '2.5rem', maxWidth: '400px', width: '100%', textAlign: 'center'}}>
        <div style={{width: '56px', height: '56px', background: '#d6f0e0', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem', fontSize: '1.5rem'}}>✓</div>
        <h1 style={{fontSize: '1.3rem', fontWeight: 500, marginBottom: '8px', color: '#1a1916'}}>¡Pago exitoso!</h1>
        <p style={{fontSize: '14px', color: '#6b6860', lineHeight: 1.6, marginBottom: '1.5rem'}}>Tu cuenta ya es Pro. Ahora tienes recibos ilimitados y todas las funciones desbloqueadas.</p>
